document.addEventListener('DOMContentLoaded', () => {
    ...
    const sharedBgContainer = document.querySelector('.shared-background-container');
    ...
    const interactiveElements = document.querySelectorAll('a, button, .interactive, .folder-project');
    ...
    function createTrailDot(x, y) {
        ...
        if (Math.random() > 0.7) { // Only create a dot 30% of the time
    ...
    function highlightNavOnScroll() {
        ...
        const homeOffset = Math.abs(document.getElementById('home').getBoundingClientRect().top);
        const projectsOffset = Math.abs(document.getElementById('projects').getBoundingClientRect().top);
        const linksOffset = Math.abs(document.getElementById('links').getBoundingClientRect().top);
        const contactOffset = Math.abs(document.getElementById('contact').getBoundingClientRect().top);
    ...
    const hoverElements = document.querySelectorAll('a, button, .project-item, .link-card, .contact-card');
